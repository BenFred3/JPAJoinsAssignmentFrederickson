	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		else if (act.equals("delete")) 
		{
			...
			try 
			{
				...
				// Create a vetHelper and delete any vet associated with the pet being deleted.
				VetHelper vh = new VetHelper();
				// This if-else statement was an attempt to make the delete work as I wanted it to.
				if (vh.searchForItemByPetId(tempID).equals(" "))
				{
					// Do nothing.
				}
				else
				{
					vh.deleteVet(vh.searchForItemByPetId(tempID));
				}
